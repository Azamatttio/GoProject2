...
func (app *application) routes() http.Handler {
	...
	menu1.HandleFunc("/cars", app.getCarsList).Methods("GET")
	// Create a new menu
	menu1.HandleFunc("/cars", app.createCarHandler).Methods("POST")
	// Get a specific menu
	menu1.HandleFunc("/cars/{id:[0-9]+}", app.getCarHandler).Methods("GET")
	// Update a specific menu
	menu1.HandleFunc("/cars/{id:[0-9]+}", app.updateCarHandler).Methods("PUT")
	// Delete a specific menu
	menu1.HandleFunc("/cars/{id:[0-9]+}", app.requirePermissions("menus:write", app.deleteCarHandler)).Methods("DELETE")
